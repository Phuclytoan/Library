    ...
    public partial class Formdocgia : Form
    {
        ...
        private void sua_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (t.thucthidulieu("update  docgia set hoten=N'" + txttendocgia.Text + "', ngaysinh=N'" + ngayhh + "', gioitinh=N'" + comgioitinh.Text + "', thongtin='" + txtlop.Text + "'where madg=N'" + txtmadocgia.Text + "'") == true)
                {
        ...
        private void xoa_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (chon == DialogResult.Yes)
                {
                    try
                    {
                        if (t.thucthidulieu("delete from docgia where madg=N'" + txtmadocgia.Text + "'") == true)
